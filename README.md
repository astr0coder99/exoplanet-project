...
2. Open the `exoplanet_analysis.ipynb` notebook using Jupyter Notebook or [Google Colab](https://colab.research.google.com/)
...
A cleaned and filtered version (`Nasa Dataset (1).csv`) is included in this repository.
